...
\href{https://www.linkedin.com/in/\mylinkedin}{\faLinkedinIn\enspace linkedin.com/in/\mylinkedinalias}\hfill
\href{tel:\myphone}{\faPhone\enspace \myphone}\hfill
\href{https://github.com/colbynoel}{\faGithub\enspace \mygithub}\hfill
\end{center}
...
% Body
\vspace{-0.1in}\setlength\parindent{24pt}\input{body}
% \indent\input{body}
